...
int main(int ac, char **av)
{
    ...
    RayTracer::PointLight pointLight(30, RayTracer::Color(0.8, 0.6, 0.2), Math::Point3D(0, 69, -8));
    RayTracer::PointLight pointLight2(16, RayTracer::Color(0.8, 0.2, 0.8), Math::Point3D(0, 50, -40));
    RayTracer::PointLight pointLight3(20, RayTracer::Color(0.2, 0.9, 0.1), Math::Point3D(0, 1, 30));
    ...
    // world.addPrimitive(std::make_shared<RayTracer::ramptésSphere>(Math::Point3D(-120, 0, -20), 10, RayTracer::Color(0.2, 0.6 ,0.2)));
    ...
    world.addPrimitive(std::make_shared<RayTracer::Sphere>(Math::Point3D(8, 12, 6), 10, RayTracer::Color(1, 1, 1)));
    world.addPrimitive(std::make_shared<RayTracer::Sphere>(Math::Point3D(-10, 20, 0), 12, RayTracer::Color(0.25, 0.25, 1)));
