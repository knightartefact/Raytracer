...
int main(int ac, char **av)
{
    ...
    RayTracer::Camera cam(Math::Point3D(0, 25, 200), resolution, std::atoi(av[1]));
    RayTracer::DirectionalLight light(0.4, RayTracer::Color(1, 1, 1), Math::Vector3D(-100, -300, -200));
    RayTracer::PointLight pointLight(100, RayTracer::Color(1, 1, 1), Math::Point3D(0, 100, -100));
    ...
    // world.addPrimitive(std::make_shared<RayTracer::Sphere>(Math::Point3D(-30, -10, -50), 20, RayTracer::Color(0, 0, 0)));
    // world.addPrimitive(std::make_shared<RayTracer::Sphere>(Math::Point3D(30, 40, -50), 20, RayTracer::Color(0.25, 0.25, 1)));
    ...
    world.addPrimitive(std::make_shared<RayTracer::Plane>(Math::Point3D(0, -50, 0), Math::Vector3D(0, 1, 0), RayTracer::Color(1, 1, 1)));
