...
int main(int ac, char **av)
{
    ...
    RayTracer::Camera cam(Math::Point3D(0, 20, 100), resolution, std::atoi(av[1]));
    ...
    world.addPrimitive(std::make_shared<RayTracer::Sphere>(Math::Point3D(-40, -10, -20), 35, RayTracer::Color(0.25, 1, 0.25)));
    world.addPrimitive(std::make_shared<RayTracer::Sphere>(Math::Point3D(60, 40, -5), 35, RayTracer::Color(1, 0.25, 0.25)));
    world.addPrimitive(std::make_shared<RayTracer::Plane>(Math::Point3D(0, -20, 0), Math::Vector3D(0, 1, 0), RayTracer::Color(0.2, 0.3, 1)));
